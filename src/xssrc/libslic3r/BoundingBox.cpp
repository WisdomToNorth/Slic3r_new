...
template <class PointClass>
void BoundingBoxBase<PointClass>::scale(double factor)
{
...
template <class PointClass>
void BoundingBoxBase<PointClass>::merge(const PointClass &point)
{
    if (this->defined)
    {
...
template <class PointClass>
void BoundingBoxBase<PointClass>::merge(const std::vector<PointClass> &points)
{
...
template <class PointClass>
void BoundingBoxBase<PointClass>::merge(const BoundingBoxBase<PointClass> &bb)
{
    if (this->defined)
    {
...
template <class PointClass>
void BoundingBox3Base<PointClass>::merge(const PointClass &point)
{
    if (this->defined)
    {
...
template <class PointClass>
void BoundingBox3Base<PointClass>::merge(const std::vector<PointClass> &points)
{
...
template <class PointClass>
void BoundingBox3Base<PointClass>::merge(const BoundingBox3Base<PointClass> &bb)
{
    if (this->defined)
    {
...
template <class PointClass>
PointClass BoundingBoxBase<PointClass>::size() const
{
...
template <class PointClass>
PointClass BoundingBox3Base<PointClass>::size() const
{
    return PointClass(this->max.x - this->min.x, this->max.y - this->min.y,
...
template <class PointClass>
double BoundingBoxBase<PointClass>::radius() const
{
...
template <class PointClass>
double BoundingBox3Base<PointClass>::radius() const
{
    double x = this->max.x - this->min.x;
    double y = this->max.y - this->min.y;
...
template <class PointClass>
void BoundingBoxBase<PointClass>::translate(coordf_t x, coordf_t y)
{
...
template <class PointClass>
void BoundingBox3Base<PointClass>::translate(coordf_t x, coordf_t y, coordf_t z)
{
...
template <class PointClass>
void BoundingBoxBase<PointClass>::offset(coordf_t delta)
{
...
template <class PointClass>
void BoundingBox3Base<PointClass>::offset(coordf_t delta)
{
...
template <class PointClass>
PointClass BoundingBoxBase<PointClass>::center() const
{
    return PointClass((this->max.x + this->min.x) / 2, (this->max.y + this->min.y) / 2);
}
template Point BoundingBoxBase<Point>::center() const;
template Pointf BoundingBoxBase<Pointf>::center() const;

template <class PointClass>
PointClass BoundingBox3Base<PointClass>::center() const
{
    return PointClass((this->max.x + this->min.x) / 2, (this->max.y + this->min.y) / 2,
...
template <class PointClass>
bool BoundingBoxBase<PointClass>::contains(const PointClass &point) const
{
