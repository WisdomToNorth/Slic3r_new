...
PrintRegion::PrintRegion(Print *print) : _print(print)
{
}
...
Print *PrintRegion::print()
{
    return this->_print;
}

Flow PrintRegion::flow(FlowRole role, double layer_height, bool bridge, bool first_layer,
                       double width, const PrintObject &object) const
{
...
bool PrintRegion::invalidate_state_by_config(const PrintConfigBase &config)
{
    ...
    {
        if (opt_key == "perimeters" || opt_key == "extra_perimeters"
            || opt_key == "min_shell_thickness" || opt_key == "gap_fill_speed"
            || opt_key == "overhangs" || opt_key == "first_layer_extrusion_width"
            || opt_key == "perimeter_extrusion_width" || opt_key == "thin_walls"
        ...
        else if (opt_key == "infill_every_layers" || opt_key == "solid_infill_every_layers"
                 || opt_key == "bottom_solid_layers" || opt_key == "top_solid_layers"
                 || opt_key == "min_top_bottom_shell_thickness" || opt_key == "min_shell_thickness"
                 ...
                 || opt_key == "infill_extrusion_width")
        {
            steps.insert(posPrepareInfill);
                 ...
                 || opt_key == "fill_angle" || opt_key == "fill_pattern"
                 || opt_key == "top_infill_extrusion_width"
                 || opt_key == "first_layer_extrusion_width" || opt_key == "infill_overlap")
        {
        ...
        else if (opt_key == "bridge_speed" || opt_key == "external_perimeter_speed"
                 || opt_key == "infill_speed" || opt_key == "perimeter_speed"
