...
#define __REGISTER_CLASS(cname, perlname)                                                          \
    template <>                                                                                    \
    const char *ClassTraits<cname>::name = "Slic3r::" perlname;                                    \
    template <>                                                                                    \
    const char *ClassTraits<cname>::name_ref = "Slic3r::" perlname "::Ref";
...
template <class T>
const char *perl_class_name(const T *)
{
    return ClassTraits<T>::name;
}
template <class T>
const char *perl_class_name_ref(const T *)
{
    return ClassTraits<T>::name_ref;
}
